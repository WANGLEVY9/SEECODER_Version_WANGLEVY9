...
- 14 个本地工具：`list_files`、`read_file`、`search_files`、`write_file`、`apply_patch`、`rename_directory`、`git_diff`、`git_status`、`git_log`、`run_command`、`search_code`、`spawn_agent`、`web_search`、`list_skills`。
